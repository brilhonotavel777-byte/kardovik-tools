...
import { IconArrowLeft, IconArrowRight, IconTrendingUp } from '@/components/icons'
  ...
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center px-6 py-24">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute left-1/2 top-1/2 h-[420px] w-[640px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/[0.07] blur-[130px]" />
      ...
      <div className="relative text-center">
        ...
        <Link
          href="/"
          className="mb-10 inline-flex items-center gap-1.5 text-xs font-medium text-slate-500 transition-colors duration-200 hover:text-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#020617] rounded"
        >
        ...
        {/* Icon */}
        <div className="mb-6 inline-flex rounded-2xl bg-blue-500/10 p-5">
          <IconTrendingUp className="text-blue-400" size={36} />
        </div>

        {/* Status badge */}
        <div className="mb-4 flex justify-center">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-blue-500/20 bg-blue-500/[0.07] px-3 py-1 text-xs font-medium text-blue-400">
