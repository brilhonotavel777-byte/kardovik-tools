...
import { IconArrowLeft, IconArrowRight, IconCreditCard } from '@/components/icons'
  ...
  return (
    <div className="relative flex flex-1 flex-col items-center justify-center px-6 py-24">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute left-1/2 top-1/2 h-[420px] w-[640px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-500/[0.07] blur-[130px]" />
      ...
      <div className="relative text-center">
        ...
        {/* Icon */}
        <div className="mb-6 inline-flex rounded-2xl bg-cyan-500/10 p-5">
          <IconCreditCard className="text-cyan-400" size={36} />
        </div>

        {/* Status badge */}
        <div className="mb-4 flex justify-center">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-cyan-500/20 bg-cyan-500/[0.07] px-3 py-1 text-xs font-medium text-cyan-400">
